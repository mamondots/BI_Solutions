const About = () => {
  return (
    <div className="bg-[url(https://i.ibb.co.com/V9VyVHj/about.png)] bg-center lg:mt-12 md:mt-12 mt-28 flex flex-col items-center justify-center text-center text-[#fff] lg:py-52 py-40">
